...
<body>
						...
						<c:forEach var="item" items="${goodsList}">
							<li>
								<div id="book">
									...
									<div class="price">
										<span>
											<fmt:formatNumber value="${item.goods_price}" type="number" var="goodss_pirce"/>
											${goods_price}원
										</span><br>
	...
	<div id="sorting">
		<ul>
			<li><a class="active" href="#">베스트셀러</a></li>
			...
			<c:forEach var="item" items="${goodsList}">
				<tr>
					<td class="goods_image">
						<a href="${contextPath}/goods/goodsDetail.do?goods_id=${item.goods_id}">
							<img width="75" alt="" src="${contextPath}/thumnails.do?goods_id=${item.goods_id}=${item.goods_fileName}">
						</a>
					</td>
					<td class="goods_descripition">
						<h2>
	...
	<div id="page_wrap">
		<ul id="page_control">
			...
			<c:forEach var="count" begin="1" end="10" step="1">
				<c:choose>
					<c:when test="${count==1}">
						<li><a class="page_control_active" href="#">${count+page_num*10}</a></li>
					</c:when>
					<c:otherwise>
